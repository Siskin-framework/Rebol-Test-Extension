...
extern u32* tst_cmd_words;
extern u32* tst_arg_words;
extern REBCNT Handle_TestExtensionCtx;
...
#define OPT_WORD_FLAG(flag, name) if (fetch_word(cmds, index, tst_arg_words, &cmd) && cmd == name) { flag = TRUE; index++; }
